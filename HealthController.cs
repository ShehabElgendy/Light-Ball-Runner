...
public class HealthController : MonoBehaviour
{
    ...
    public void DamagePlayer(int damageAmount)
    {
        ...
        if (invincCounter <= 0)
        {
            ...
            bulletPrefab1.GetComponent<BulletController>().DecreaseMoveSpeed(decreaseMoveSpeedAmount);
            bulletPrefab2.GetComponent<BulletController>().DecreaseMoveSpeed(decreaseMoveSpeedAmount);
            bulletPrefab3.GetComponent<BulletController>().DecreaseMoveSpeed(decreaseMoveSpeedAmount);
            bulletPrefab4.GetComponent<BulletController>().DecreaseMoveSpeed(decreaseMoveSpeedAmount);
    ...
    public void Revive()
    {
        ...
        transform.position = new Vector3(TimerController.instance.transform.position.x - 37.4f , TimerController.instance.transform.position.y, 0f);
